...
// `sportsing fifa agent-setup` — the discoverable front door for an agent-driven
...
function printGuide(): void {
  const b = c.bold;
  console.log(`${b(c.cyan("⚽ sportsing agent-setup"))} — set up an agent-driven watch session
